...
const AdminPanelPro = (): JSX.Element => {
  ...
  useEffect(() => {
    if (!roleLoading && (isSuperAdmin() || isAdmin())) { // isSuperAdmin() implica isAdmin()
  ...
  const loadPricingConfig = async () => {
    try {
      if (!adminApiService) return;
      log('💰 Caricamento configurazione prezzi...');
                    ...
                    <form onSubmit={handleCreateCalendar}>
                      <div className="pricing-controls">
                        ...
                        <select
                          ...
                          title="Seleziona il tipo di calendario"
                        ...
                        <input
                          ...
                          className="admin-input-small"
                          title="Inserisci l'URL del feed iCal"
          ...
          {activeTab === 'admin-management' && isSuperAdmin() && (
            <div className="admin-panel-management">
              ...
              <div className="admin-pricing-section">
                ...
                <div className="admin-notice admin-notice-superadmin-only">
