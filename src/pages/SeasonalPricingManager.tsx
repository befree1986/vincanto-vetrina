...
import { useBookingRules, SeasonalRule } from '../hooks/useBookingRules'; // Percorso corretto
import AdminApiService from '../services/adminApiService'; // Percorso corretto
import '../components/admin/SeasonalPricingManager.css'; // Percorso corretto
